...
class AstNodeDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final content = switch (astNode) {
      ...
      final AugmentationImportDirective _ => const Text('Coming soon...'),
      ...
      final LibraryAugmentationDirective _ => const Text('Coming soon...'),
      ...
      final OnClause _ => const Text('Coming soon...'),
