...
String getAstNodeTypeName(AstNode node) {
  return switch (node) {
    ...
    final ExtensionOnClause _ => 'ExtensionOnClause',
    ...
    final MixinOnClause _ => 'MixinOnClause',
    ...
    final NullAwareElement _ => 'NullAwareElement',
...
extension AstNodeX on AstNode {
  Uri get url {
    return Uri.https(
      'pub.dev',
      '/documentation/analyzer/latest/dart_ast_ast/${getAstNodeTypeName(this)}-class.html',
    );
  }
}
